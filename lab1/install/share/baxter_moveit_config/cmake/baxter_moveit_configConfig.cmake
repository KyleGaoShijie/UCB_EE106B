...
if("FALSE" STREQUAL "TRUE")
  ...
  set(baxter_moveit_config_DEVEL_PREFIX /home/cc/ee106b/sp17/class/ee106b-aau/UCB_EE106B/lab1/devel)
  ...
  set(baxter_moveit_config_INSTALL_PREFIX /home/cc/ee106b/sp17/class/ee106b-aau/UCB_EE106B/lab1/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'baxter_moveit_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106b/sp17/class/ee106b-aau/UCB_EE106B/lab1/install/${idir}'.  Ask the maintainer 'MoveIt Setup Assistant <assistant@moveit.ros.org>, Rethink Robotics Inc. <rsdk.support@rethinkrobotics.com>' to fix it.")
    endif()
